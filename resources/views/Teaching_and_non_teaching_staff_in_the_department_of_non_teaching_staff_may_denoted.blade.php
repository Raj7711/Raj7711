       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 var addcontrols="<tr>"
                 addcontrols+="<td><input type='radio' id='gender' name='Designation' value='Professor'>Professor<br><input type='radio' id='gender' name='Designation' value='Associate Professor'>Associate Professor<br><input type='radio' id='gender' name='Designation' value='Asistant Professor'>Assistant Professor<br><input type='radio' id='gender' name='Designation' value='Sr. Technical Assistant'>Sr.Technical Assistant<br><input type='radio' id='gender' name='Designation' value='Technical Assistant'>Technical Assistant<br><input type='radio' id='gender' name='Designation' value='Assistant'>Assitant <br><input type='radio' id='gender' name='Designation' value='UDC'>UDC<br><input type='radio' id='gender' name='Designation' value='LDC'>LDC<br><input type='radio' id='gender' name='Designation' value='Peon'>Peon<br></td>"

...
<form action="sfellowship" method="post">
  @csrf
<table id="customers">
  <tr>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 var addcontrols="<tr>"
                 addcontrols+="<td><input type='radio' id='gender' name='variables' value='Course'>Course<br><input type='radio' id='gender' name='variables' value='Details of fellowship/scholarship/financial support received by students/scholars'>Details of<br>fellwoship/scholarship<br>financial support received <br>by students/scholars</td>"
                 addcontrols+="<td><input type='int' name='details'></td>"

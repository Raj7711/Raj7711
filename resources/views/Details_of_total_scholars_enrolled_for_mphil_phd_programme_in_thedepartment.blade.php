...
<form action="enrollphd" method="post">
  @csrf
<table id="customers">
  <tr>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 ...
                 addcontrols+="<td><input type='int' name='no'></td>"
                 addcontrols+="<td><input type='radio' id='gender' name='programme' value='M.Phil'>M.Phil<br><input type='radio' id='gender' name='programme' value='Ph.d'>Ph.d</td>"

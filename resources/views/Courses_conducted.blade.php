...
#customers th {
  ...
  <body>
  <h3>7(b)Courses Conducted by the Department for Ph.D programme</h3>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 var addcontrols="<tr>"
                  addcontrols+="<td><input type='text' name='cou'></td>"
                 addcontrols+="<td><input type='text' name='com'></td>"
                 addcontrols+="<td><input type='int' name='num'></td>"

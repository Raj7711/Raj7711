...
<form action="{{url('/')}}/sstudent1" method="post">
  @csrf
<table id="customers">
  <tr>
    
  <th >Si no</th>
  <th>Courses/PG/Semester.</th>
    <th >SC</th>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 ...
                 addcontrols+="<td><input type='radio' id='gender' name='PG' value='I'>I<br><input type='radio' id='gender' name='PG' value='II'>II<br><input type='radio' id='gender' name='PG' value='III'>III<br><input type='radio' id='gender' name='PG' value='IV'>IV<br><input type='radio' id='gender' name='PG' value='M.Phil'>M.Phil<br><input type='radio' id='gender' name='PG' value='Ph.D'>Ph.D</td>"

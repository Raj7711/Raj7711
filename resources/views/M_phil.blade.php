...
#customers th {
  ...
  <body>
  <h3>10(b)Details of scholars Resistered for M.Phil programme under year of report</h3>
...
<tbody>
          ...
          <tr>
            ...
            <td>{{$programme->register}}</td>
            <td>{{$programme->tit}}</td>
            <td>{{$programme->super}}</td>
          </tr>
          @endforeach
       </tbody>
<tfoot>
       ...
       <script type="text/javascript">
        $(document).ready(function() {
           $("#newrows").click(function(){
                 ...
                 addcontrols+="<td><input type='int' name='register'></td>"
                 addcontrols+="<td><input type='text' name='tit'></td>"
                 addcontrols+="<td><input type='text' name='super'></td>"
                     addcontrols+= "</tr>";
